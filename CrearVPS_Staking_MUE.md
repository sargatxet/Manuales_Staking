...
1.  Selección de servicio VPS y necesidades mínimas:
...
5.  Configuración del acceso seguro al escritorio del VPS. Para ello, dependiendo del ordenador con el que estemos trabajando deberemos usar uno de estos mecanismos:
...
6.  Configurar cliente _VNC_. Casi todos los clientes VNC funcionan de manera similar. Deberemos configurarlos para que se conecten al puerto local 5901 y así aprovechar el tunel seguro que hemos creado con el cliente _SSH_.
...
7. Instalar billetera staking:

    - **MonetaryUnit**: Para instalar dicha billetera deberemos seguir las siguientes instrucciones desde una consola de comandos del VPS del escritorio remoto:
